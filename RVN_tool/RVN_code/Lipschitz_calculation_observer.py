...
class LipschitzCalculation:
    ...
    #
    #         if (cluster_center.max() - cluster_center.min()) < standard_deviation:
    #             self.majo.append(L)
    #             self.mino.append([None])
    #         else:
    #         # 预测每个数据点的簇标签
    ...
    #             self.mino.append(np.setdiff1d(data, data[labels == most_frequent_label]))
