...
class ConfigHandler:
    ...
    def add_common_options(self):
        ...
        h = ["general"]
        self.add_argument("--device", type=str, default="cpu", choices=["cpu", "cuda", "xpu"],
                          help='Select device to run verifier, cpu or cuda (GPU) or xpu(Intel GPU).',
                          hierarchy=h + ["device"])
        self.add_argument("--seed", type=int, default=22, help='Random seed.',
                          hierarchy=h + ["seed"])
        ...
        self.add_argument("--norm", type=float, default='inf',
                          ...
                          hierarchy=h + ["norm"])
        self.add_argument("--epsilon", type=float, default=0.0,
        ...
        h = ["solver", "crown"]
        self.add_argument('--crown_batch_size', type=int, default=int(10),
                          help='Batch size in batched CROWN.',
                          hierarchy=h + ["batch_size"])
        self.add_argument('--max_crown_size', type=int, default=int(10),
        ...
        self.add_argument("--cut_lr_decay", type=float, default=1.0,
                          ...
                          hierarchy=h + ["lr_decay"])
        self.add_argument("--cut_iteration", type=int, default=30,
        ...
        self.add_argument("--filter_batch_size", type=int, default=100,
        ...
        self.add_argument('--nonlinear_split_use_min',
                          action="store_true",
                          help='Use min instead of mean to aggregate the branching scores of multiple branches.',
                          hierarchy=h + ['use_min'])
        ...
        self.add_argument("--dynamic_nonlinear_split_bbps", action="store_true",
                          help="Decide branching points dynamically by BBPS.",
                          hierarchy=h + ['dynamic_bbps'])
        self.add_argument("--dynamic_nonlinear_split_options", nargs="+",
                          help="Different options of branching points.",
                          default=["uniform", "three_left", "three_right"],
                          hierarchy=h + ['dynamic_options'])
        ...
        self.add_argument('--bf_iters', type=int, default=50,
                          help='Number of iterations to use brute force.',
                          hierarchy=h + ['bf_iters'])
        self.add_argument('--bf_batch_size', type=int, default=50,
        ...
        self.add_argument('--perturbed_amount_ns', type=int, default=100,
                          ...
                          hierarchy=h + ['N_s'])
        self.add_argument('--dynamic_steps', type=int, default=200,
                          help="The steps of NNCS.",
                          hierarchy=h + ['steps'])
        self.add_argument('--rvn_epsilon', type=float, default=0,
                          help="The epsilon of the perturbations samples.",
                          hierarchy=h + ['epsilon'])
        self.add_argument('--dichotomy_iterations', type=int, default=20,
                          help="Control the iteration of the dichotomy for the best epsilon.",
                          hierarchy=h + ['dichotomy_iterations'])
        self.add_argument('--rvn_timeout', type=float, default=3600.0,
                          help="Timeout for verification or testing.",
                          hierarchy=h + ['timeout'])
        self.add_argument('--rvn_attack_method',type=str,default="PGD",
                          choices=["PGD", "CW"],
                          help="Control the attack method in attack_pgd.py 1271.",
                          hierarchy=h + ["attack_method"])
        self.add_argument('--rvn_framework',type=str,default="Ori",
                          choices=["REN","PGD", "CW","Ori"],
                          help="Control the framework in abcrown.py 597.",
                          hierarchy=h + ["framework"])                  

        h = ["change"]
        self.add_argument('--changed_batch_size',type=int,default=200,
                          help="The original code seems to unable change batchsize by arguments in batch_branch_and_bound.py 154.",
                          hierarchy=h + ["batch_size"])
        self.add_argument('--changed_attack_iters', type=int, default=200,
                          help="The original code seems to unable change attack_iters(attack iterations) by arguments in attack_pgd.py 616.",
                          hierarchy=h + ["attack_iters"])
        self.add_argument('--changed_num_restarts', type=int, default=2000,
                          help="The original code seems to unable change num_restarts(num of testing samples in once iteration) "
                               "by arguments in attack_pgd.py 617.",
                          hierarchy=h + ["num_restarts"])
    ...
    def update_eps(self,eps_new):
        self["rvn_setting"]["epsilon"] = eps_new
